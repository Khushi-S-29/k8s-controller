...
\section{Steps to Build a CronJob Kubernetes Controller}
\begin{frame}{Steps to Follow}
    \begin{enumerate}
...
\begin{frame}{Challenges Faced}
    \begin{itemize}
        ...
        \item Go environment shuts down when the laptop is powered off, causing interruptions.
